...
v = VideoWriter('ant.avi');%ant.avi is the video for the amount of pheromone between two cities
open(v)
for it = 1:iter
    if 0==0
...
close(v);
v = VideoWriter('ant1.avi');%ant1.avi is the video for the path that our algorithm currently chooses.
open(v)
t_ = size(route,1);
for i = 1:t_
hold off
